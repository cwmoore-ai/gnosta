...
exports.LongTermMemoryManager = exports.PatternCategory = exports.ProjectStatus = exports.ProjectCategory = exports.Priority = exports.TaskStatus = exports.MemoryCategory = void 0;
...
async function createRedisClient(mcpServerName = 'redis') {
    // This would be implemented to connect to Context7 MCP server
    ...
    return {
        ...
        zadd: async (key, scoreOrItems, member) => { },
        zrange: async (key, start, stop) => [],
        zrangebyscore: async (key, min, max) => [],
        hset: async (key, fieldOrValue, value) => { },
...
//# sourceMappingURL=LongTermMemoryManager.js.map